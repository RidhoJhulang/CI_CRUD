						...
						<form action="<?php base_url(" admin/customer/edit") ?>" method="post"
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('phone_number') ? 'is-invalid':'' ?>"
								 type="text" name="phone_number" min="0" placeholder="Customer Phone Number" value="<?php echo $customer->phone_number ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('address') ? 'is-invalid':'' ?>"
								 name="address" placeholder="Customer address..."><?php echo $customer->address ?></textarea>
								<div class="invalid-feedback">
